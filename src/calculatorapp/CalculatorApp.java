...
public class CalculatorApp implements ActionListener {
    ...
    JButton buttonSaven = new JButton("7");
    ...
    public void addComponent(){
        ...
        buttonSaven.setBounds(10, 230, 60, 40);
        buttonSaven.setFont(new Font ("Arial",Font.BOLD,20));
        buttonSaven.setFocusable(false);
        frame.add(buttonSaven);
    ...
    public void addActionEvent(){
        ...
        buttonSaven.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {    
     ...
     Object source = e.getSource();
        ...
        if(textField.getText().contains(".")){
            ...
            textField.setText(Double.toHexString(sqrt));
